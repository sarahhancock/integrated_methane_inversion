...
config_required: Dict[str, Rule] = {
    ...
    "Res": ["0.125x0.15625", "0.25x0.3125", "0.5x0.625", "2.0x2.5", "4.0x5.0"],
    "Met": ["GEOSFP", "MERRA2"],
    "RunSetup": bool,
...
optional_rules: Dict[str, Rule] = {
    ...
    "ResumableMonthlyKalman": bool,
    "MonthlyKalmanStage": str,
    "MonthlyKalmanEndDate": int,
    "MonthlyKalmanStartDate": int,
    "MonthlyKalmanNudgeFactor": float,
    "MonthlyKalmanRequireResidualSo": bool,
    "MonthlyKalmanPreserveResidualSo": bool,
    "MonthlyKalmanAdjustPriorWithScaleFactors": bool,
    "MonthlyKalmanClipNegativeK": bool,
    "MonthlyKalmanDryRun": bool,
    "UseSatDiagnOverpass": bool,
    "PriorCovarianceMethod": str,
    "NationalPriorUncertaintyFile": str,
    "NationalPriorCountryMaskFile": str,
    "NationalPriorCountryMaskVariable": str,
    "NationalPriorCountryShapefile": str,
